...
def main():
    ...
    # For testing, just pulling a few players
    dfs = []
...
if __name__ == "__main__":
    main()
# This script fetches NBA player career stats, saves them to a DuckDB database, and uploads the database to an S3 bucket.
